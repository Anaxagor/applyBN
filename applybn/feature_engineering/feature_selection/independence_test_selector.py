...
class ITFeatureSelector(FeatureSelector):
    """
    Class for feature selection based on independence tests
    """
    ...
    def select_features(
        ...
        # TODO: Implement feature selection using independence tests
        return dummy
